...
function ContactFrom({ className = "", id }) {
  ...
  return (
    <div id={id} className={`${className}`.trim()}>
      ...
      <AnimatedButton text="Use The Form" onClick={() => handleShow(true)} />

      <Modal show={show} onHide={() => setShow(false)} fullscreen={fullscreen} centered>
        <Modal.Body
        ...
        >
          <Container className="my-auto" style={{ maxWidth: "400px", backgroundColor: "#fff" }}>
            ...
            <AnimatedButton text="Submit" onClick={handleSubmit} className={styles.submitButton} />
